...
// validated) are newly PORTED and moved out of UNAVAILABLE. Each genuinely executes given grounded
...
// guaranteed for an ordinary query (absent it, each honestly reports SKIPPED). Only Multi-Agent
// Orchestrator remains UNAVAILABLE this checkpoint (out of scope, per instruction).
// =================================================================================================
