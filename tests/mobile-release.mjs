...
await open('/riddim/daw/','#play');
for(const sel of ['#play','#stop']){const b=await page.locator(sel).boundingBox();assert(b&&b.width>=40&&b.height>=34,`${sel} too small for touch`);}
