...
(function(global){
  ...
  FTN.IbisIntelligenceClientExtension={applied:true,capabilities:['CORRELATION_ANALYSIS','CAPITAL_SCENARIO','CONTEXT_GRAPH_QUERY','INTENT_STORE','OPPORTUNITY_MATCH']};
