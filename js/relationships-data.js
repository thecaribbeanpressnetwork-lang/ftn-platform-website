  ...
  var relationships = [
    {
      ...
      classification: 'Illustrative', sampleSize: '1,204 road reports', timeCoverage: '24 months', geoCoverage: 'National',
      ...
      limitations: 'Illustrative relationship — correlation does not establish causation; other factors (traffic volume, weather) are not isolated here.',
    ...
    },
    {
      ...
      classification: 'Illustrative', sampleSize: '36 months rainfall vs. reports', timeCoverage: '3 years', geoCoverage: 'National',
      methodology: 'Illustrative correlation between 30-day rainfall totals and flood-related community reports.',
      limitations: 'Illustrative only — drainage capacity and land use are confounding variables not modelled here.',
    ...
    },
    {
      ...
      classification: 'Illustrative', sampleSize: '18 months', timeCoverage: '18 months', geoCoverage: 'Regional',
    ...
    },
    {
      ...
      classification: 'Illustrative', sampleSize: 'National quarterly series', timeCoverage: '5 years', geoCoverage: 'National',
      methodology: 'Illustrative correlation between unemployment rate and the household financial pressure index.',
      limitations: 'Illustrative — inflation and cost-of-living are likely co-contributors, not separated out here.',
    ...
    },
    {
      ...
      classification: 'Illustrative', sampleSize: 'Business survey sample', timeCoverage: '2 years', geoCoverage: 'National',
      ...
      limitations: 'Illustrative — sample skews toward transport-dependent businesses.',
    ...
    },
    {
      ...
      classification: 'Illustrative', sampleSize: 'Limited regional sample', timeCoverage: '2 years', geoCoverage: 'Tobago',
      methodology: 'Illustrative correlation between monthly tourism receipts and regional employment figures.',
      limitations: 'Low confidence — small sample size and strong seasonality not fully adjusted for in this illustrative.',
    ...
    },
    {
      ...
      classification: 'Illustrative', sampleSize: 'RPI basket component', timeCoverage: 'Ongoing', geoCoverage: 'National',
      ...
      limitations: 'Illustrative — actual basket weighting not modelled in this illustrative.',
      value: 'component', units: '',
    },
  ];
