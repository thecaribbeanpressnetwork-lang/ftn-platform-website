...
(function (global) {
  ...
  var relationships = [
    ...
    },
    {
      ...
      classification: 'Demonstration', sampleSize: 'RPI basket component (demo)', timeCoverage: 'Ongoing', geoCoverage: 'National',
  ...
  global.FTN.Relationships = { all: relationships, get: get, forIndicator: forIndicator, random: random };
})(window);
