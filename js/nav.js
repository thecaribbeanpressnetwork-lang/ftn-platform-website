...
// sub-menu is rendered inline (see .no-js rules in css/components/nav.css).
(function () {
  ...
  // Shared FTN capabilities load once rather than being duplicated across product pages.
