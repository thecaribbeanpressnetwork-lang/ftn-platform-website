...
(function () {
  ...
  document.querySelectorAll('a[href="/contact/#investors"],a[href="/contact/?#investors"]').forEach(function (a) {
    ...
    a.textContent = 'FTN InvestIn';
  });

  var PRIMARY_LINKS=[['Home','/'],['FTN Directory','/applications/'],['FTN Live','/observatory/'],['FTN Parliament','/parliament/'],['FTN TV','/tv/'],['FTN Kaiso','/kaiso/'],['FTN Riddim','/riddim/'],['FTN InvestIn','/invest/'],['About FTN','/about/'],['Contact','/contact/']];
  ...
  function normalizeFooter(){document.querySelectorAll('.site-footer__columns').forEach(function(footer){footer.innerHTML='<div><p class="site-footer__heading">FTN Directory</p><div class="site-footer__links"><a href="/applications/">FTN Directory</a><a href="/observatory/">FTN Live</a><a href="/parliament/">FTN Parliament</a><a href="/tv/">FTN TV</a><a href="/kaiso/">FTN Kaiso</a><a href="/riddim/">FTN Riddim</a><a href="/invest/">FTN InvestIn</a></div></div><div><p class="site-footer__heading">FTN</p><div class="site-footer__links"><a href="/about/">About FTN</a><a href="/contact/">Contact</a><a href="/account/">FTN Account</a><a href="/trust/">Trust Centre</a><a href="/sitemap/">Sitemap</a></div></div><div><p class="site-footer__heading">Legal and access</p><div class="site-footer__links"><a href="/legal/privacy-policy/">Privacy</a><a href="/legal/terms-of-service/">Terms</a><a href="/accessibility/">Accessibility</a><a href="/legal/copyright/">Copyright</a></div></div>';});document.querySelectorAll('.site-footer__bottom-links').forEach(function(row){row.innerHTML='<a href="/sitemap/">Sitemap</a><a href="/accessibility/">Accessibility</a><a href="/applications/">FTN Directory</a>';});}
  normalizeFooter();
