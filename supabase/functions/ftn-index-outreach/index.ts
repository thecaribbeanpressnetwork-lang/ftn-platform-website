...
Deno.serve(async req=>{
  ...
  for(const q of queues||[]){
    ...
    const subject=`${entity.display_name} has been indexed by FTN — please verify your business information`;
    const html=`<!doctype html><html><body style="font-family:Arial,sans-serif;background:#0b0b0c;color:#f5f5f5;padding:24px"><div style="max-width:620px;margin:auto;background:#141416;border:1px solid #2a2a2d;border-radius:16px;padding:28px"><div style="font-weight:800;letter-spacing:.08em;color:#E10613">FTN INDEX</div><h1 style="font-size:24px">${esc(entity.display_name)}</h1><p>While building FTN Index, we identified publicly available information for <strong>${esc(entity.display_name)}</strong>.</p><p>FTN Index is a Caribbean project designed to help standardize public business information so people, search systems and emerging AI services can find clearer, more consistent information about Caribbean businesses.</p><p><strong>This is the information FTN has currently found about your business from public sources.</strong> Please take a moment to verify what is correct and update anything that is not.</p><p>There is no charge to review, correct or confirm your factual business information.</p><p><a href="${claimUrl}" style="display:inline-block;background:#E10613;color:white;text-decoration:none;padding:12px 18px;border-radius:10px;font-weight:700">Verify ${esc(entity.display_name)} information</a></p><p style="font-size:13px;color:#b9b9bd">The review link expires in 14 days. If you do not respond, nothing changes and the provisional record remains unconfirmed.</p><p style="font-size:13px;color:#b9b9bd">FTN confirmation means the organization recently reviewed its indexed public information. It is not an endorsement, safety rating or guarantee.</p><p style="font-size:12px;color:#8e8e93">FTN Index is part of the FTN Platform, owned by Boss Consulting. FTN is building Caribbean digital infrastructure to make regional information easier to discover, verify and use. · ftnplatform.org</p></div></body></html>`;
