...
| Canonical release marker | git tag `v1.2.1` — authoritative; resolve it (`git rev-parse v1.2.1`) rather than trusting a hardcoded hash in this file, which necessarily can't name its own commit |
